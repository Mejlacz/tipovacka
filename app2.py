...
SECRET_USER_EMAIL = "kubamartinec97@gmail.com"
...
# api_parsers import je zakomentován - API se nepoužívá
...
ACHIEVEMENTS = {
    ...
    'nostradamus': {'name': 'Nostradamus', 'icon': '🔮', 'description': 'Tipoval jsi překvapení jako první (velký outsider)', 'color': '#a78bfa'},
